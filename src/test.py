...
# out = ssr_s_runner.infer_one("./imgs/picture.jpg", prefix="third", batch_id="ssr_s", return_arrays=False)
ssr_s_runner.infer_many("C:/Users/tobia/Downloads/hyper-skin-data/Hyper-Skin(RGB, VIS)/**/*.jpg", glob_recursive=True, no_prefix=True)